...
<%@ page import="java.io.*" %>
			...
			try {
			    ...
			    String query= "Select userid, username, pass_word, full_name, address, credit_card,utype from users where userid<>'"+user+"'";
			    ...
			    {
			    	%>
			    	<h3 align="center"><%out.println(rs1.getString("full_name"));%>,Here is the list of all the users.</h3>
			    	<br></br>
